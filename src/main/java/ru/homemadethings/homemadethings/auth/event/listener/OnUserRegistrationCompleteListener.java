 ...
 */
package ru.homemadethings.homemadethings.auth.event.listener;

import ru.homemadethings.homemadethings.auth.event.OnUserRegistrationCompleteEvent;
import ru.homemadethings.homemadethings.auth.exception.MailSendException;
import ru.homemadethings.homemadethings.auth.model.User;
import ru.homemadethings.homemadethings.auth.service.EmailVerificationTokenService;
import ru.homemadethings.homemadethings.auth.service.MailService;
