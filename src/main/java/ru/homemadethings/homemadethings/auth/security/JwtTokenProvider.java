 ...
 */
package ru.homemadethings.homemadethings.auth.security;
...
public class JwtTokenProvider {
    ...
    public String generateToken(CustomUserDetails customUserDetails) {
        ...
        return Jwts.builder()
                ...
                .claim("emailIsVerified", customUserDetails.getEmailVerified())
                .claim("roles", customUserDetails.getRoles().stream().map(Role::getRole).collect(Collectors.toList()))
                .compact();
    }
